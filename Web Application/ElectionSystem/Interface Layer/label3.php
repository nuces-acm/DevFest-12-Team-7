...
<head>
  <title>DevFest ACM 2012 | Election System - Candidate Options</title>
...
<script type="text/javascript">
	...
	function validate(){
		...
		function func()
		{
			alert("Request for seat is posted to the administrator");
		}
  ...
  <div id="site_content">
    ...
    <div id="content">
		...
		<div class="disignBoxFirst">
			<div class="boxFirstHeader"> Welcome Name</div>
			...
			<br><br>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="submit" name="cast vote" value="Cast Vote" onClick="redirect();">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="submit" name="apl_4_seat" value="Apply for Seat" onClick="func();">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
